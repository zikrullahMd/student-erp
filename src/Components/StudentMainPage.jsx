...
const StudentMainPage = () => {
  ...
  if (!currentUser) {
    return <div>Loading...</div>; // You can also redirect to the login page or handle this scenario differently
  }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-500 to-indigo-500">
      <div className="bg-white p-8 rounded-md shadow-lg w-full md:w-3/4 lg:w-1/2 xl:w-1/3">
        <h1 className="text-3xl font-bold mb-4 text-gray-800">Welcome, {currentUser.name}!</h1>
